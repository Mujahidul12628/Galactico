...
const Footer = () => {
    return (
        <div className="p-10 mx-auto text-white footer-bg ">
            <div className="grid items-start justify-between w-full grid-cols-2 gap-10 mx-auto max-w-7xl sm:grid-cols-2 md:grid-cols-4">
